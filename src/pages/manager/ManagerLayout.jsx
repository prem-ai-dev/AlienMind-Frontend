...
import { LayoutDashboard, FolderKanban, UsersRound, CheckSquare, LogOut } from "lucide-react";
...
const NAV_ITEMS = [
  ...
  { label: "Project", icon: FolderKanban, to: "/manager/projects" },
  { label: "Team", icon: UsersRound, to: "/manager/teams" },
  { label: "Task", icon: CheckSquare, to: "/manager/tasks" },
];
...
export default function ManagerLayout() {
  ...
  const username = decoded?.username || decoded?.sub || "Manager";
